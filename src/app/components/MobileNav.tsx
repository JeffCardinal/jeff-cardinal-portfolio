  ...
  return (
    <div className="">
      <button
        ...
        onClick={handleClick}
        className={`z-50 fixed top m-5 p-2 outline outline-[5px] text-black bg-white rounded-full text-md hover:bg-rose-500 hover:text-white transition duration-300 ${
          hover ? "shadow-lg" : ""
        }`}
      >
        <svg
      ...
      >
        ...
        >
          <div className="font-distancia text-4xl">Home</div>
        </Link>
        <Link
          href="/about"
          onClick={handleClick}
        ...
        >
          <div className="font-distancia text-4xl">Resume</div>
        </Link>
      </div>
    </div>
  );
