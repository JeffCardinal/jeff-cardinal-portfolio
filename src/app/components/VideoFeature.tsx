...
export default function VideoFeature() {
  return (
      <div className="box-border lg:p-8 items-center justify-center flex flex-3 flex-col lg:flex-row bg-black">
        <Video 
        videoUrl="/videos/videos-optimized/ditb-reel.mp4"
        ...
        <Video 
        videoUrl="/videos/videos-optimized/funk-forever-reel.mp4"
        title={"Funk Forever Party"}
        description={""} caseStudyUrl={""} />
          {/* Future Funk party promotion reel. */}
        <Video 
        videoUrl="/videos/videos-optimized/sega-dreamland-reel.mp4"
        ...
        <Video 
        videoUrl="/videos/videos-optimized/tribal-heart-reel.mp4"
        ...
        <Video 
        videoUrl="/videos/videos-optimized/metalheartreel1.mp4"
