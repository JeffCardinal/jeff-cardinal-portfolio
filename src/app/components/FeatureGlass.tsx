      ...
      <div className={`relative box-border p-8 flex flex-col lg:flex-row overflow-hidden bg-sky-400 ${textColor}`}>
        ...
        <div className="flex-1 lg:pl-8">
          ...
          <div className={`flex-col max-w-[1000px]`}>
            ...
            <span 
                className="observableRight opacity-0 relative w-full block text-3xl lg:text-4xl font-distancia z-10"
                style={{ lineHeight: 1 }}
            >
                {title}
            </span>
            ...
            <div className="observableRight opacity-0 relative">{children}</div>
          </div>
