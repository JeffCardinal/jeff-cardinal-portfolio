...
export default function Page() {
  return (
    <div className="bg-white">
      <div
        className={`flex min-h-screen min-w-screen bg-sky-400 text-center items-center justify-center`}
      >
        <div className="justify-center flex sm:flex-row flex-wrap">
          ...
          <div className="justify-start text-start sm:px-2 px-8 lg:w-[500px] md:w-[300px] sm:w-[300px] text-white">
            ...
            <div className="p-6">
              ...
              <div className="pt-4">
                I've worked as a Software Engineer and SEII for The Home Depot
                and Greenlight Financial Technologies respectively.
              </div>
              <div className="pt-4">
